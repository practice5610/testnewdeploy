...
let ReturnRequestRepository = class ReturnRequestRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource) {
        super(models_1.ReturnRequestModel, dataSource);
    }
};
ReturnRequestRepository = tslib_1.__decorate([
