...
exports.MySequenceWithoutRedis = void 0;
const tslib_1 = require("tslib");
const context_1 = require("@loopback/context");
const rest_1 = require("@loopback/rest");
const authorization_1 = require("./authorization");
const SequenceActions = rest_1.RestBindings.SequenceActions;
let MySequenceWithoutRedis = class MySequenceWithoutRedis {
    constructor(findRoute, parseParams, invoke, send, reject, authenticateRequest, checkAuthorization) {
...
], MySequenceWithoutRedis.prototype, "invokeMiddleware", void 0);
MySequenceWithoutRedis = tslib_1.__decorate([
    ...
    tslib_1.__param(5, context_1.inject(authorization_1.AuthorizatonBindings.AUTHENTICATE_ACTION)),
    tslib_1.__param(6, context_1.inject(authorization_1.AuthorizatonBindings.AUTHORIZE_ACTION)),
    tslib_1.__metadata("design:paramtypes", [Function, Function, Function, Function, Function, Function, Function])
], MySequenceWithoutRedis);
exports.MySequenceWithoutRedis = MySequenceWithoutRedis;
//# sourceMappingURL=sequenceWithoutRedis.js.map