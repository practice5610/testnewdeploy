...
exports.POSTShippingCheckoutExample = exports.GETShippingPolicyExample = exports.POSTShippingBoxExample = exports.POSTShippingPolicyExample = exports.GETShippingOrderExample = exports.POSTEstimateShippingCostExample = exports.POSTRefundShippingExample = exports.GETShippingLabelsExample = exports.GETShippoTransactionExample = exports.POSTPurchaseRateExample = exports.POSTShippingRateExamples = exports.POSTAddressValidationExamples = void 0;
const constants_1 = require("../../../constants");
// TODO: Use helpers for testing to build the response data here
exports.POSTAddressValidationExamples = {
    SUCCESS_MISSING_APT: {
        success: true,
...
exports.POSTShippingRateExamples = {
    SUCCESS: {
        success: true,
        message: constants_1.APIResponseMessages.SUCCESS,
        data: [
...
exports.POSTPurchaseRateExample = {
    SUCCESS: {
        success: true,
        message: constants_1.APIResponseMessages.SUCCESS,
...
exports.GETShippoTransactionExample = {
    SUCCESS: {
        success: true,
        message: constants_1.APIResponseMessages.SUCCESS,
        data: {
            ...
            tracking_url_provider: 'https://tools.usps.com/go/TrackConfirmAction_input?origTrackNum=92612901755477000000000010',
        },
    },
};
exports.GETShippingLabelsExample = {
    SUCCESS: {
        success: true,
        message: constants_1.APIResponseMessages.SUCCESS,
        data: [
...
exports.POSTRefundShippingExample = {
    SUCCESS: {
        success: true,
        message: constants_1.APIResponseMessages.SUCCESS,
...
exports.POSTEstimateShippingCostExample = {
    SUCCESS: {
        success: true,
        message: constants_1.APIResponseMessages.SUCCESS,
        data: {
...
exports.GETShippingOrderExample = {
...
exports.POSTShippingPolicyExample = {
    // TODO: Update to use ResponseAPI
    SUCCESS: {
...
exports.POSTShippingBoxExample = {
    SUCCESS: {
        success: true,
        message: 'success',
        data: {
...
exports.GETShippingPolicyExample = {
    // TODO: Update to use ResponseAPI
    SUCCESS: {
        _id: '60538b0dcd4f425104999599',
        createdAt: 1616087821,
...
//# sourceMappingURL=shipping-specifications-responses.js.map