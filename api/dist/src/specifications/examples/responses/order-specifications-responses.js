...
exports.GETOrdersByIdResponseExamples = exports.GETOrdersResponseExamples = exports.GETOrdersCountResponseExamples = void 0;
const database_helpers_1 = require("../../../__tests__/helpers/database.helpers");
const constants_1 = require("../../../constants");
exports.GETOrdersCountResponseExamples = {
    SUCCESS: {
        success: true,
        message: constants_1.APIResponseMessages.SUCCESS,
        data: database_helpers_1.givenCount(),
    },
};
//TODO: convert this function to use database.helper
exports.GETOrdersResponseExamples = {
    SUCCESS: {
        success: true,
        message: constants_1.APIResponseMessages.SUCCESS,
        data: {
                    ...
                    bookings: [
                        {
                            ...
                            item: {
                                ...
                                _tags: [],
                                imageUrl: 'https://d1k0ppjronk6up.cloudfront.net/products/4030/nmcpics_095_095046PK_IT_IM.jpg',
                                merchantUID: 're5OljVl3KObKLopKdxpOQBWPL82',
                                name: 'Dump & Bake Desserts (One Pan. Dump. Stir. Bake)-',
                                description: 'CQ Products-Dump & Bake Desserts. Grab a baking pan, add your ingredients, stir and bake! It is that easy! Create tarts, pies, cookies, bards, cakes and more. This book contains thirty dessert recipes. Spiral-bound; 64 pages. Published year: 2014. ISBN 978-1- 56383-494-3. Made in USA.',
                                ...
                                store: {
                                    ...
                                    companyLogoUrl: 'https://apiqa.boomcard.net/api/v1/images/re5OljVl3KObKLopKdxpOQBWPL82-logo',
                                    coverImageUrl: 'https://apiqa.boomcard.net/api/v1/images/re5OljVl3KObKLopKdxpOQBWPL82_cover',
                                    companyType: '',
                                    companyDescription: 'We are a t-shirt selling store in USA, West Palm Beach, test test',
                                    links: [
                                        'boomreward.com',
            ...
            transactions: [
                {
                    _id: { $oid: '60770aab2c07b01458ff24d6' },
                ...
                {
                    _id: { $oid: '60770aab2c07b01458ff24d7' },
                    createdAt: 1618414250,
                    type: 'purchase',
                    status: 'completed',
                    amount: { amount: 696, precision: 2, currency: 'USD', symbol: '$' },
                ...
                {
                    _id: { $oid: '60770aab2c07b01458ff24d8' },
...
//TODO: convert this function to use database.helper
exports.GETOrdersByIdResponseExamples = {
    SUCCESS: {
        success: true,
        message: 'success',
        data: {
...
//# sourceMappingURL=order-specifications-responses.js.map