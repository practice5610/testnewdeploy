...
exports.PATCHDisputeResponseExample = exports.PATCHReturnRequestResponseExample = exports.POSTDisputeResponseExamples = exports.POSTReturnRequestResponseExamples = exports.POSTReturnPolicyResponseExamples = void 0;
const constants_1 = require("../../../constants");
exports.POSTReturnPolicyResponseExamples = {
    SUCCESS: {
        success: true,
...
exports.POSTReturnRequestResponseExamples = {
    SUCCESS: {
        success: true,
        message: constants_1.APIResponseMessages.SUCCESS,
        data: {
...
exports.POSTDisputeResponseExamples = {
    SUCCESS: {
        success: true,
        message: constants_1.APIResponseMessages.SUCCESS,
        data: {
            ...
            isOpen: true,
            comment: 'Wrong item was delivered and Merchant is refusing to replace for correct item or refund',
        },
    },
};
exports.PATCHReturnRequestResponseExample = {
    SUCCESS: {
        success: true,
        message: constants_1.APIResponseMessages.SUCCESS,
        data: {
...
exports.PATCHDisputeResponseExample = {
    SUCCESS: {
        success: true,
        message: constants_1.APIResponseMessages.SUCCESS,
        data: {
...
//# sourceMappingURL=returns-examples.js.map